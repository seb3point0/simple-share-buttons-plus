...
function ssbp_get_font_family()
{
    ...
    return "@font-face {
					font-family: 'ssbp';
					src:url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.eot?5276i0');
					src:url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.eot?#iefix5276i0') format('embedded-opentype'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.woff2?5276i0') format('woff2'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.woff?5276i0') format('woff'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.ttf?5276i0') format('truetype'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.svg?5276i0#ssbp') format('svg');
					font-weight: normal;
					font-style: normal;
